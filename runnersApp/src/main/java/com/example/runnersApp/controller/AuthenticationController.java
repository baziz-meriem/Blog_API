...
import com.example.runnersApp.responses.LoginResponse;
import com.example.runnersApp.service.impl.AuthenticationService;
...
public class AuthenticationController {
    ...
    public ResponseEntity<User> register(@RequestBody RegisterUserDto registerUserDto) {
        ...
        log.info("Signup request: {}", registerUserDto);
